        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <x-tarjetas.dashboard>
                    ...
                    <x-general.link-dashboard color="gray" title="Mascotas" ruta="" />
                </x-tarjetas.dashboard>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <x-tarjetas.dashboard>
                        ...
                        <x-general.link-dashboard color="gray" title="Usuarios" ruta="" />
                    </x-tarjetas.dashboard>
                    ...
                    <x-tarjetas.dashboard>
                        ...
                        <x-general.link-dashboard color="gray" title="Roles" ruta="" />
                    </x-tarjetas.dashboard>
                    ...
                    <x-tarjetas.dashboard>
                        ...
                        <x-general.link-dashboard color="gray" title="Especies" ruta="" />
                    </x-tarjetas.dashboard>
                </div>
            </div>
        @endif
